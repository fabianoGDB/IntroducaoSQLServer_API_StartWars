...
namespace ConroleAcesso.Dao
{
    public abstract class DaoBase: IDisposable
    {
        ...
        protected DaoBase()
        {
            ...
            // Altere o data source
            con = new SqlConnection(@"Data Source=DESKTOP-H0N4AH0\SQLEXPRESS;Initial Catalog=EstrelaDaMorte;Integrated Security=True;Connect Timeout=30");
        }
